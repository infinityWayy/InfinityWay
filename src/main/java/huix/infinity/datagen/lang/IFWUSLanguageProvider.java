...
public class IFWUSLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(IFWItems.gold_pickaxe.get(), "Gold Pickaxe");
        add(IFWItems.gold_shears.get(), "Gold Shears");
        add(IFWItems.gold_shovel.get(), "Gold Shovel");
        add(IFWItems.gold_hoe.get(), "Gold Hoe");
        add(IFWItems.gold_sword.get(), "Gold Sword");
        add(IFWItems.gold_axe.get(), "Gold Axe");
...
//        add(IFWItems.obsidian_shovel.get(), "Obsidian Shovel");
        ...
        add(IFWItems.gold_helmet.get(), "Gold Helmet");
        add(IFWItems.gold_chestplate.get(), "Gold Chestplate");
        add(IFWItems.gold_leggings.get(), "Gold Leggings");
        add(IFWItems.gold_boots.get(), "Gold Boots");
        add(IFWItems.gold_chainmail_helmet.get(), "Gold Chainmail Helmet");
        add(IFWItems.gold_chainmail_chestplate.get(), "Gold Chainmail Chestplate");
        add(IFWItems.gold_chainmail_leggings.get(), "Gold Chainmail Leggings");
        add(IFWItems.gold_chainmail_boots.get(), "Gold Chainmail Boots");
    }
}
