...
public class IFWCNLanguageProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(IFWItems.gold_pickaxe.get(), "金镐");
        add(IFWItems.gold_shears.get(), "金剪刀");
        add(IFWItems.gold_shovel.get(), "金锹");
        add(IFWItems.gold_hoe.get(), "金锄");
        add(IFWItems.gold_sword.get(), "金剑");
        add(IFWItems.gold_axe.get(), "金斧");
...
//        add(IFWItems.obsidian_shovel.get(), "黑耀石锹");
        ...
        add(IFWItems.gold_helmet.get(), "金头盔");
        add(IFWItems.gold_chestplate.get(), "金胸甲");
        add(IFWItems.gold_leggings.get(), "金护腿");
        add(IFWItems.gold_boots.get(), "金鞋子");
        add(IFWItems.gold_chainmail_helmet.get(), "金锁链头盔");
        add(IFWItems.gold_chainmail_chestplate.get(), "金锁链胸甲");
        add(IFWItems.gold_chainmail_leggings.get(), "金锁链护腿");
        add(IFWItems.gold_chainmail_boots.get(), "金锁链鞋子");
    }
}
