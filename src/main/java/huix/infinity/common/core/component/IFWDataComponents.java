...
public class IFWDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<EnchantmentRecipe>> enchantment_recipe = DATA_COMPONENTS.registerComponentType("enchantment_recipe",
            builder -> builder.persistent(EnchantmentRecipe.DIRECT_CODEC).networkSynchronized(EnchantmentRecipe.DIRECT_STREAM_CODEC).cacheEncoding());
