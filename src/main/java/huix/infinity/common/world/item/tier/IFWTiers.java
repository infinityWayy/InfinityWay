...
public enum IFWTiers implements IFWTier {
    WOOD(IFWBlockTags.INCORRECT_FOR_LEVEL_0_TOOL, 1, 1.0F, 0.0F, 0,
    ...
    SILVER(IFWBlockTags.INCORRECT_FOR_LEVEL_1_TOOL, 4, 1.75F, 3.0F, 30,
            8, 800, 1, () -> Ingredient.of(IFWItems.silver_nugget)),
    GOLD(IFWBlockTags.INCORRECT_FOR_LEVEL_1_TOOL, 4, 1.75F, 3.0F, 50
            , 99999999, 800, 1, () -> Ingredient.of(Tags.Items.NUGGETS_GOLD)),
    IRON(IFWBlockTags.INCORRECT_FOR_LEVEL_2_TOOL, 8, 2.0F, 4.0F, 30,
            20, 1600, 2, () -> Ingredient.of(Tags.Items.NUGGETS_IRON)),
    ANCIENT_METAL(IFWBlockTags.INCORRECT_FOR_LEVEL_2_TOOL, 16, 2.0F, 4.0F, 40,
            30, 3200, 3, () -> Ingredient.of(IFWItems.ancient_metal_nugget)),
    MITHRIL(IFWBlockTags.INCORRECT_FOR_LEVEL_3_TOOL, 64, 2.5F, 5.0F, 100,
            40, 12800, 4, () -> Ingredient.of(IFWItems.mithril_nugget)),
    ADAMANTIUM(IFWBlockTags.INCORRECT_FOR_LEVEL_4_TOOL, 256, 3.0F, 6.0F, 40,
