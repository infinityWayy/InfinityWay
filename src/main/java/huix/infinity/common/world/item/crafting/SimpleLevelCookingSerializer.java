...
public class SimpleLevelCookingSerializer<T extends AbstractCookingLevelRecipe> implements RecipeSerializer<T> {
    private final AbstractCookingLevelRecipe.Factory<T> factory;
    private final MapCodec<T> codec;
    private final StreamCodec<RegistryFriendlyByteBuf, T> streamCodec;

    public SimpleLevelCookingSerializer(AbstractCookingLevelRecipe.Factory<T> factory, int cookingTime) {
        this.factory  = factory;
        this.codec = RecordCodecBuilder.mapCodec(instance -> instance.group(
                Codec.STRING.optionalFieldOf("group", "").forGetter(AbstractCookingLevelRecipe::getGroup),
                ...
                Codec.FLOAT.fieldOf("experience").orElse(0.0F).forGetter(AbstractCookingLevelRecipe::getExperience),
                Codec.INT.fieldOf("cookingtime").orElse(cookingTime).forGetter(AbstractCookingLevelRecipe::getCookingTime),
                Codec.INT.fieldOf("cookinglevel").orElse(0).forGetter(AbstractCookingLevelRecipe::cookingLevel))
