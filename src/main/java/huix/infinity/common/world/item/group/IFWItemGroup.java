    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> tool_tab =
            CREATIVE_TABS.register("tool_tab", () -> CreativeModeTab.builder().title(Component.translatable("itemGroup.ifw.tool_tab"))
                    ...
                    .displayItems((parameters, output) -> {
                        ...
                        output.accept(IFWItems.gold_helmet.get());
                        output.accept(IFWItems.gold_chestplate.get());
                        output.accept(IFWItems.gold_leggings.get());
                        output.accept(IFWItems.gold_boots.get());
                        ...
                        output.accept(IFWItems.gold_chainmail_helmet.get());
                        output.accept(IFWItems.gold_chainmail_chestplate.get());
                        output.accept(IFWItems.gold_chainmail_leggings.get());
                        output.accept(IFWItems.gold_chainmail_boots.get());
