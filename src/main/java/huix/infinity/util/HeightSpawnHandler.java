...
public class HeightSpawnHandler {
    ...
    public static boolean checkDeepSlateLayerSpawnRules(
            @NotNull EntityType<? extends Mob> type, @NotNull ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random
    ) {
    ...
    public static boolean checkUniversalSpawnRules(
            @NotNull EntityType<? extends Monster> type, @NotNull ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random
    ) {
    ...
    public static boolean checkSurfaceLayerSpawnRules(
            @NotNull EntityType<? extends Monster> type, @NotNull ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random
    ) {
    ...
    public static boolean checkWoodSpiderSpawnRules(
            @NotNull EntityType<? extends Monster> type, @NotNull ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random
    ) {
